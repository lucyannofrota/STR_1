...
static void *thread_start(void *arg){
    ...
    calc_func_ripple_alt(sim_func,35e6,1000, N_SAMPLES,(*tab)[0]);
    calc_func_ripple_alt(sim_func,55e6,1000, N_SAMPLES,(*tab)[1]);
    calc_func_ripple_alt(sim_func,85e6,1000, N_SAMPLES,(*tab)[2]);
